...
export class CourseService {
    ...
    constructor(private http: Http) {
        this.courses = [
            {id: 1, title: 'Video course 1', duration: 88, createdDate: new Date(), topRated: false, description: 'Ante laborum massa, suspendisse sed adipiscing lectus magna, congue consectetuer aliquam quis magna tincidunt animi, lacus faucibus aliquam sed, neque wisi ac in arcu mi velit. In sit neque nibh faucibus vel. Felis eget id sed at. Eget mauris. Metus morbi quis consectetuer dictumst, pellentesque non, eu lectus non feugiat vel elementum, non commodo duis, magna accumsan.'},
            {id: 2, title: 'Video course 2', duration: 15, createdDate: new Date(), topRated: true, description: 'Ante laborum massa, suspendisse sed adipiscing lectus magna, congue consectetuer aliquam quis magna tincidunt animi, lacus faucibus aliquam sed, neque wisi ac in arcu mi velit. In sit neque nibh faucibus vel. Felis eget id sed at. Eget mauris. Metus morbi quis consectetuer dictumst, pellentesque non, eu lectus non feugiat vel elementum, non commodo duis, magna accumsan.'},
            {id: 3, title: 'Video course 3', duration: 135, createdDate: new Date(), topRated: false, description: 'In dictum ultricies sed. Massa elit posuere sit scelerisque, nullam commodi, wisi litora interdum tortor. Nulla quam rutrum, mollis odio wisi ac tempus, vehicula wisi tristique eget maecenas, suspendisse et neque elit nonummy arcu congue.'},
            {id: 4, title: 'Video course 4', duration: 45, createdDate: new Date(), topRated: false, description: 'Est penatibus nulla proin eleifend integer nonummy, non consequuntur vestibulum donec nullam penatibus, sociis elementum morbi, consequat ut eget sociis. Integer lacinia ligula blandit vestibulum, commodo volutpat quam quis, pede suspendisse aliquam duis non lectus praesent, proin justo, pede sit sit nec. Ut donec pellentesque et cum, per faucibus ac eu.'}
        ];
    }
